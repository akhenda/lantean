...
import { NormalizedSchema, DateGeneratorSchema } from './schema';

import { getImportPath, getNpmScope } from '../../utils';

/**
 * Normalize options for the Date generator.
 *
 ...
 */
export function normalizeOptions(tree: Tree, options: DateGeneratorSchema): NormalizedSchema {
