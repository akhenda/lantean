...
const deprecate = require('eslint-plugin-deprecate');
...
module.exports = [
  ...
  /**
   * Shopify ESNext config overrides
   */
  {
    languageOptions: {
      parser: babelParser,
   ...
   */
  // promisePlugin.configs['flat/recommended'], // Already defined in the shopify block

  /**
   * eslint-plugin-sort-class-members
   */
  // sortClassMembers.configs['flat/recommended'], // Already defined in the shopify block
